...
@EnableJpaRepositories("lk.ijse.gdse.webapp_gradle.repo")
public class HibernateConfig {

    @Autowired
    private Environment environment;
    public HibernateConfig(){
        System.out.println("Hibernate Started - Default");
    }
    @Autowired
    ...
    // Transaction
    @Bean
    public PlatformTransactionManager transactionManager(@Autowired LocalContainerEntityManagerFactoryBean emf) {
